									...
									>
										<CardHeader>
											...
											<div className='flex items-center relative'>
												...
												/>
												<span className='absolute top-1/2 text-sm left-[45%] min-[375px]:left-[35%] min-[425px]:left-[31%] -translate-x-[45%] md:left-[45%] md:-translate-x-[45%] lg:left-[45%] xl:left-[24%] xl:-translate-x-[22%] lg:-translate-x-[45%] -translate-y-1/2 dark:text-black'>
													{progress.toFixed(0) + ' %'}
												</span>
