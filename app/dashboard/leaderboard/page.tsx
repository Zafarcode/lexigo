			...
			{sections.map((section, key) => {
				...
				return (
					<div key={section.id}>
									...
									<div className='  flex justify-center items-start flex-col sm:flex-row mx-auto gap-0 sm:gap-10'>
										<div className=' flex justify-start flex-col items-center gap-5'>
											<div className=' imageBox w-[250px]'>
												<Image
													src={
														'https://d35aaqx5ub95lt.cloudfront.net/images/leagues/660a07cd535396f03982f24bd0c3844a.svg'
													}
													width={50}
													height={50}
													alt='league icon'
											...
											<div className=' title '>
												...
												<h4 className=' text-center text-xl'>
													Complete 9 more lessons to enter the competition
												</h4>
											</div>
											<Link href={'/dashboard/vocabulary'}>
												<Button className=' text-blue-400 py-5 px-10'>
													START LESSON
												</Button>
											</Link>
											<div className=' relative overflow-hidden w-full h-[300px] '>
												<div className='grid grid-cols-[auto_1fr_auto] max-w-full w-full py-0 pr-6 pl-7 gap-4'>
													<Image
														...
														height={464}
														alt=''
														className='object-contain mr-6 pt-4'
													/>
													<Image
									...
									<div className='flex flex-col justify-center items-start mx-auto gap-10 z-10'>
										<div className=' w-full mx-auto  flex flex-col justify-center items-center gap-3 z-30'>
											<div className=' imageBox w-[60px] h-[60px] relative'>
												<Image
													src={
														'https://d35aaqx5ub95lt.cloudfront.net/images/leagues/80fecb328c5aefd400db229794fd7a08.svg'
													}
													fill
													alt='league icon'
													className=' object-contain w-full'
											...
											<div className=' title '>
												...
												<p className=' text-center text-xl'>
													7 winners move on to the next league
												</p>
												<p className=' endTime text-center text-lg font-semibold text-yellow-400'>
													4 day
												</p>
											</div>
										</div>
                        ...
                        ${
													item.condition === 'user' && item.id > 22
														? 'bg-red-200 text-red-600 dark:bg-gray-900 hover:bg-red-200'
														: item.condition === 'user' && item.id < 8
														? 'bg-green-200 text-green-600 dark:bg-gray-900 hover:bg-green-200'
														: item.condition === 'user' &&
														  item.id > 7 &&
														  item.id < 23
														? ' bg-gray-300'
                      ...
                      `}
														...
														>
															...
															<div className=' relative mr-2'>
																...
																{item.condition === 'user' ? (
																	<Button
																		className=' absolute -top-3 -right-5 flex items-center justify-center w-[30px] h-[30px] bg-gray-100 rounded-full border-2 border-dashed border-gray-300 p-0'
												...
												className={` ${
													isMobile
														? isVisible
															...
															: 'block fixed translate-y-0 z-50 border-t-2 border-gray-200'
														: 'translate-y-0'
											...
											>
												<div className=' w-full h-[50px] text-3xl font-semibold sm:font-normal sm:text-lg flex justify-center sm:justify-between items-center mb-3 sm:m-0'>
													...
													{selectedIcon === dataStatuses[0].url ? (
														...
														<Button
															className=' hidden sm:block text-lg border-none text-blue-400 font-medium hover:bg-white dark:bg-black'
															onClick={handleIconClearClick}
														>
															Clear
														</Button>
													)}
												...
												<div className=' flex flex-col justify-center items-center gap-5'>
													<div className='relative'>
														<div className=' w-[75px] h-[75px] rounded-full overflow-hidden'>
															<Image
																src={'/assets/icons/profileIcon1.svg'}
																alt=''
																width={50}
																height={50}
													...
													<div className=' block sm:hidden w-full'>
														<Button
															className=' w-full bg-blue-400 font-medium text-lg text-white dark:text-gray-800 dark:border-blue-600'
															onClick={toggleStatus}
														>
															READY
														</Button>
													...
													<div className=' block sm:hidden w-full'>
														<Button
															className=' w-full text-lg border-none text-blue-400 font-medium hover:bg-white dark:bg-black'
															onClick={handleIconClearClick}
														>
															CLEAR STATUS
														</Button>
