	...
	return (
		<main className='pt-24 md:pt-28'>
				...
				<div className='relative'>
					...
					{progressVisible && (
						<div className='absolute top-[0] right-[0] flex gap-2 items-center'>
							<h3 className='text-xl text-primary font-sans mt-[52px] md:mt-2'>
								{formatTime(time)}
							</h3>
						</div>
					)}
			...
			<Dialog
				...
				onOpenChange={() => setIsTimeUpDialogOpen(true)}
			>
				<DialogContent className='sm:max-w-[425px]'>
					<DialogHeader>
						<DialogTitle>Time is Up!</DialogTitle>
						<DialogDescription>
							Unfortunately, your time is up. You scored {score} out of{' '}
							{CardElement.length} correct answers.
						</DialogDescription>
					</DialogHeader>
					<DialogFooter className='flex justify-center items-center '>
						<NextLink href={'/'}>
							<Button onClick={() => setIsTimeUpDialogOpen(false)}>
								Go to Home
							</Button>
						</NextLink>
					</DialogFooter>
